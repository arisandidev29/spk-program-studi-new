...
>
    ...
    <ul class="mx-auto mt-8 flex w-[80%] flex-col gap-2">
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = config("custome.sidebar"); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li>
                <a
...
<?php endif; ?>
<?php /**PATH /home/arisandi/Documents/skripsi/spk-program-studi-new/resources/views/components/sidebar.blade.php ENDPATH**/ ?>
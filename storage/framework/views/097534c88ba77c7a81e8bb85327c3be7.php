...
<div
    class="relative rounded-xl bg-white p-4 shadow-xl md:p-8 dark:bg-gray-800 dark:text-gray-100"
>
    <h1 class="font-poppins font-bold"><?php echo e($kriteria); ?></h1>
    <p
        class="font-roboto text-xs leading-6 text-gray-600 md:text-sm dark:text-gray-500"
    >
        <?php echo e($question); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($note): ?>
        ...
        <span
            class="bg-primary rounded-2xl px-2 py-2 text-sm text-white dark:text-gray-300"
        >
            Note !
        </span>
...
<?php /**PATH /home/arisandi/Documents/skripsi/spk-program-studi-new/resources/views/components/question-head.blade.php ENDPATH**/ ?>
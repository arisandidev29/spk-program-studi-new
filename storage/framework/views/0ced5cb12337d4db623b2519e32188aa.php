...
<?php $component->withAttributes([]); ?>
    <div class="grid grid-cols-2 mt-12 items-center justify-around">
        <div class="font-poppins">
            ...
            <h1 class="text-5xl font-bold flex items-center gap-4 my-4">
                <img src="/asset/logo.svg" alt="logo" class="inline-block w-38">
                Jawaban nya
            </h1>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['class' => 'block bg-secondary text-black ']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block bg-secondary text-black ']); ?>Mulai Pilihan Mu <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div>
            <img src="/asset/welcome-image.svg" alt="welcome image" class="w-[70%]" id="welcome-image">
        </div>
    </div>

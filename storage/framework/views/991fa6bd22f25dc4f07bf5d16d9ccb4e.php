...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '{ sidebar: false, isMobile: window.innerWidth < 768 }','x-init' => 'window.addEventListener(\'resize\', () => { isMobile = window.innerWidth < 768 })','header' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'footer' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'class' => 'grid max-w-full! grid-cols-1 bg-gray-100 p-0! md:grid-cols-[345px_1fr] dark:bg-gray-800']); ?>
...
<?php endif; ?>
<?php /**PATH /home/arisandi/Documents/skripsi/spk-program-studi-new/resources/views/components/admin-layout.blade.php ENDPATH**/ ?>
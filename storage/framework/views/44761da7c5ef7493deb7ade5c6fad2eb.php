                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $alternatives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="text-xs md:text-sm">
                        ...
                        <td>
                            <a
                                wire:navigate
                                href="<?php echo e(route("admin.alternative.edit", $value->id)); ?>"
                            >
                                <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1276676704-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH /home/arisandi/Documents/skripsi/spk-program-studi-new/resources/views/livewire/alternative-table.blade.php ENDPATH**/ ?>
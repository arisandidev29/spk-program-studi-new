...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['xData' => '{ sidebar: false, isMobile: window.innerWidth < 768 }','xInit' => 'window.addEventListener(\'resize\', () => { isMobile = window.innerWidth < 768 })','header' => false,'footer' => false,'class' => 'grid max-w-full! grid-cols-1 bg-gray-100 p-0! md:grid-cols-[345px_1fr]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '{ sidebar: false, isMobile: window.innerWidth < 768 }','x-init' => 'window.addEventListener(\'resize\', () => { isMobile = window.innerWidth < 768 })','header' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'footer' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'class' => 'grid max-w-full! grid-cols-1 bg-gray-100 p-0! md:grid-cols-[345px_1fr]']); ?>

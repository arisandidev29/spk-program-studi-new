                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $bobots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bobot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="text-xs md:text-sm" id="bobot-<?php echo e($bobot->id); ?>">
                        ...
                        <td>
                            <a
                                wire:navigate
                                href="<?php echo e(route("admin.bobot.edit", $bobot->id)); ?>"
                            >
                                <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2599852635-0', $__slots ?? [], get_defined_vars());
...
<?php $component->withAttributes(['x-data' => '{show : false, id : \'\', name : \'\'}','x-on:modaldelete-open.window' => '
        ...
        <h1 class="text-primary my-4 text-2xl">
            ...
            <small class="block text-xs md:text-sm">
                <span class="font-bold text-red-500 italic">Warning !!</span>
                Kriteria yang menggunakan Bobot ini juga akan ikut terhapus !!
            </small>
        </h1>
...
<?php endif; ?><?php /**PATH /home/arisandi/Documents/skripsi/spk-program-studi-new/resources/views/livewire/bobot-table.blade.php ENDPATH**/ ?>
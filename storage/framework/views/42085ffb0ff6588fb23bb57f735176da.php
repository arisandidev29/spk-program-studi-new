<div
    x-data="{
        show: false,
        playsound() {
            const audio = new Audio('<?php echo e(asset("asset/sound.mp3")); ?>')
            audio.play()
        },
    }"
    x-show="show"
...
>
    ...
    <!--[if BLOCK]><![endif]--><?php if($isPdfUrlGenerated): ?>
...
</div><?php /**PATH /home/arisandi/Documents/skirpsi/spk-program-studi-new/resources/views/livewire/pdf-export-popup.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes(['class' => 'my-2 aspect-video w-full']); ?>
                <canvas
                    id="UserRegistration"
                    width="200px"
                    data-user-registration-data="<?php echo e(json_encode($userRegistrationData)); ?>"
                ></canvas>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53747ceb358d30c0105769f8471417f6)): ?>
...
<?php $component->withAttributes(['class' => 'py-8']); ?>
                ...
                <div class="my-2">
                    <!--[if BLOCK]><![endif]--><?php if(!$presentaseProgramStudi): ?>
...
<?php $component->withAttributes(['class' => 'my-4']); ?>
                <!--[if BLOCK]><![endif]--><?php if(!$distribution): ?> 
                    <p class="text-center text-gray-500">
                ...
                <canvas
                    id="TotalUserChart"
                    data-user-distribution="<?php echo e(json_encode($distribution)); ?>"
                ></canvas>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/arisandi/Documents/skripsi/spk-program-studi-new/resources/views/livewire/admin-dashboard.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes(['class' => 'grid place-items-center']); ?>
    <div class="grid  md:grid-cols-2 gap-4 items-center mt-[12vh]">
        <div class="order-2 md:order-1">
            <h2 class="flex items-center justify-center md:justify-start font-poppins gap-4 text-xl md:text-3xl font-bold">Apa itu <img src="/asset/logo.svg" alt="logo" class=" w-22 md:w-36"> ?</h2>
            <p class=" mt-4 md:my-6 text-xs md:text-sm font-roboto leading-8">

...
[$__name, $__params] = $__split('program-studi-answer', ['kriteriaId' => ''.e($kriteria->id).'','kriteria_id' => ''.e($kriteria->id).'','programStudi' => ''.e($alternative->name).'']);
...
<?php endif; ?><?php /**PATH /media/arisandi/New Volume/coding/skripsi/spk-program-studi/resources/views/livewire/kriteria-list.blade.php ENDPATH**/ ?>
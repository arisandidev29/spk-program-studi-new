<svg
    <?php echo e($attributes->merge(["class" => "w-8 h-8 text-white group-hover:text-primary duration-300"])); ?>
...
<?php /**PATH /media/arisandi/New Volume/coding/skripsi/spk-program-studi/resources/views/components/svg/users.blade.php ENDPATH**/ ?>
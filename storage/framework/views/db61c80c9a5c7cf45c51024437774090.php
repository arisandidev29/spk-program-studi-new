...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.radio-option','data' => ['value' => ''.e($value->nilai).'','label' => ''.e($index + 1).'','description' => ''.e($value->name).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['value' => ''.e($value->nilai).'','label' => ''.e($index + 1).'','description' => ''.e($value->name).'']); ?>

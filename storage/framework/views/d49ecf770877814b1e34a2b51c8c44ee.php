...
<div class="relative bg-white shadow-xl p-8 rounded-xl">
    ...
    <p class="font-roboto text-sm text-gray-600 "><?php echo e($question); ?></p>
    ...
    <!--[if BLOCK]><![endif]--><?php if($note): ?>
        ...
        <p class="my-2 text-sm"><?php echo e($note); ?></p>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

    <span class="absolute top-5 -left-12 flex justify-center items-center w-8 h-8   bg-primary text-white rounded-full" ><?php echo e($number); ?></span>
</div><?php /**PATH /media/arisandi/New Volume/coding/skripsi/spk-program-studi/resources/views/components/question-head.blade.php ENDPATH**/ ?>
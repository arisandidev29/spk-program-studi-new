...
<div class="relative rounded-xl bg-white p-8 shadow-xl">
    ...
    <span
        class="bg-primary absolute top-5 -left-12 flex h-8 w-8 items-center justify-center rounded-full text-white"
    >
        <?php echo e($number); ?>

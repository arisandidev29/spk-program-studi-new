    ...
    <div  class="relative">
        ...
        <div
            ...
            <ul class="font-poppins flex flex-col gap-1">
                <li><a href="{{route('dashboard')}}" class="group flex items-center gap-4 hover:bg-gray-500 hover:transition hover:duration-500 transition duration-300 p-2 rounded-md">

<x-admin-layout title="Kriteria" breadcrumbs="kriteria">
    <x-card class=" max-w-5xl mx-auto">
        ...
        <a href="" class="my-4 inline-block">
            <x-button class="text-white bg-primary">Buat Kriteria </x-button>
        </a>
                ...
                <div class="relative">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex gap-4 items-center">
                            <x-button class="group hover:bg-amber-500 duration-300 flex items-center gap-2 text-sm px-2! bg-secondary text-black">
                                Edit
                            ...
                            <x-button class="bg-red-500 p-1! hover:bg-red-700 duration-300">
